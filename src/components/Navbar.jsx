...
//   const location = useLocation(); // 2. Detect URL changes
//   const [showConfirm, setShowConfirm] = useState(false);
//   const [currentUser, setCurrentUser] = useState(null);
//   const [isMobileOpen, setIsMobileOpen] = useState(false);

//   // 3. Define a function to check user status
...
//     // Add event listener for custom "auth-change" event (See step 2 below)
...
//     };
//   }, [location]); // 5. Re-run this effect whenever the URL (location) changes
...
//               <img src={Logo01} alt="VRL Logo" />
//             </div>
//             <span>VRL Product</span>
//           </Link>

//           {/* --- Mobile Toggle --- */}
//           <div className="menu-icon" onClick={() => setIsMobileOpen(!isMobileOpen)}>
//             {isMobileOpen ? <CloseIcon /> : <MenuIcon />}
//           </div>

//           {/* --- Navigation Links --- */}
//           <ul className={isMobileOpen ? "nav-menu active" : "nav-menu"}>
...
//             <li className="nav-item"><Link to="/product" className="nav-links" onClick={closeMenu}>Products</Link></li>
...
//                     <Link to="/my-orders" className="nav-links active-link" onClick={closeMenu}>
//                       My Orders
//                     </Link>
//                   </li>
//                 )}
...
//                   <li className="nav-item">
//                     <Link to="/my-supplies" className="nav-links active-link" onClick={closeMenu}>
//                       My Supplies
//                     </Link>
//                   </li>
//                 )}
...
//               <button className="btn btn-text" onClick={cancelLogout}>Cancel</button>
