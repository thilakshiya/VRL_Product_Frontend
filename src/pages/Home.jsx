...
import pro02Img from "../assets/pro02.webp";
import heroImg from "../assets/Copilot_20251208_144053-removebg-preview (1).png";
import susImg from "../assets/image5.jpeg";
...
========================= */
const productsData = [
  { id: 1, name: "Premium Cocoa", price: 1200, img: vegImg },
  { id: 2, name: "Industrial Steel", price: 5400, img: proImg },
  { id: 3, name: "Organic Spices", price: 850, img: pro02Img },
];
    ...
    <div style={styles.container}>
      ...
      <header className="hero-wrap" style={styles.heroSection}>
        <div style={styles.heroLeft}>
          ...
          <div style={styles.heroActions}>
            <Link to="/product" style={styles.btnPrimary}>Shop Now</Link>
            <Link to="/register" style={styles.btnSecondary}>Join Us</Link>
          </div>

          <div style={styles.statsBar}>
            <span><strong>5k+</strong> Products</span>
            <span><strong>1.2k+</strong> Users</span>
            <span><Leaf size={16}/> 24/7 Support</span>
          </div>
        </div>

        <div style={styles.heroRight}>
          <img src={heroImg} alt="Hero" style={styles.heroImg} />
        </div>
      </header>

      {/* ================= FEATURES ================= */}
      <section style={styles.section}>
        <h2 style={styles.h2Center}>Why Choose VRL?</h2>

        <div style={styles.grid}>
          <Feature icon={<Shield />} title="Trusted Platform" text="Secure payments & verified suppliers." />
          <Feature icon={<Truck />} title="Fast Delivery" text="On-time delivery guaranteed." />
          <Feature icon={<Star />} title="Premium Quality" text="Top quality products assured." />
          <Feature icon={<Leaf />} title="Eco Friendly" text="Sustainable & green sourcing." />
        </div>
      </section>
          ...
          {productsData.map(item => (
            <div key={item.id} style={styles.productCard}>
              ...
              <div style={styles.productDetails}>
                <h4>{item.name}</h4>
                <p>Rs {item.price}</p>
                <button style={styles.btnAdd}>Add to Cart</button>
              </div>
            </div>
          ))}
        </div>
      ...
      {/* ================= SUSTAINABLE ================= */}
      <section style={styles.susSection}>
        <div>
          <h2 style={styles.h2}>Sustainable Trading</h2>
          <p>Connecting eco-friendly suppliers with responsible buyers.</p>

          <div style={styles.susItem}>
            <Check /> Supplier Partnerships
          </div>
          <div style={styles.susItem}>
            <Leaf /> Eco Conscious Buyers
          </div>
        </div>

        <img src={susImg} alt="Sustainable" style={styles.susImg}/>
      </section>

      {/* ================= TESTIMONIALS ================= */}
      <section style={styles.section}>
        <h2 style={styles.h2Center}>What Our Clients Say</h2>
        ...
        <div style={styles.grid}>
          <Testimonial
            ...
            text="VRL transformed our sourcing process."
          />
          <Testimonial
            img="https://i.pravatar.cc/150?img=44"
            name="Anita S."
            role="Organic Farmer"
            text="Fair pricing & excellent platform."
          />
          <Testimonial
            img={avatar3}
            name="Mike K."
...
const Testimonial = ({ img, name, role, text }) => (
...
const styles = {
  ...
  heroImg: { maxWidth: "420px", width: "100%" },
  h1: { fontSize: "3rem", color: "#2d4f43" },
  h2: { fontSize: "2rem", color: "#2d4f43" },
  h2Center: { textAlign: "center", fontSize: "2rem" },
  highlight: { color: "#568c76" },
  subtitle: { color: "#6b7c75", maxWidth: "450px" },
  heroActions: { display: "flex", gap: "15px", margin: "20px 0" },
  btnPrimary: {
    background: "#568c76",
    color: "#fff",
    padding: "12px 30px",
  ...
  productImg: { width: "100%", height: "200px", objectFit: "cover" },
  ...
  susItem: { display: "flex", gap: "10px", marginTop: "10px" },
  susImg: { width: "100%", maxWidth: "400px", borderRadius: "20px" },
  testimonial: {
    background: "#fff",
    padding: "25px",
    borderRadius: "20px",
